<!--
******* CHANGE PORT NUMBER IN LINE  42 WITH ONE GIVEN FROM Mobitel
-->	
...
class SMPP{     
	 ...
	 */
	function SMPP($host, $port=5016){   //get deprecated above PHP 7.2.18 so rename as function _construct($host, $port=5016) {
		//internal parameters
